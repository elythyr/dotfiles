...
ICON_COLOR="%{F#b4b7b4}"  # Color for the icons
...
function output() {
    ...
    if [ "$isMuted" = "yes" ]; then
        ...
        echo "${ICON_FONT}${ICON_COLOR}${volIcon}${END_FONT}${END_COLOR} ${curVol}% ${SINK_ICON}${nickname}"
        # echo "${ICON_FONT}${ICON_COLOR}${nickname}${END_FONT}${END_COLOR} ${curVol}%"
    fi
}
